      ...
      <div className='w-full h-full items-center  justify-center flex relative'>
        ...
        >
          ...
          <span ref={group} id='group'>
            <span ref={dot_01} className='animate-loading-dot delay-300'>.</span>
            <span ref={dot_02} className='animate-loading-dot delay-600'>.</span>
            <span ref={dot_03} className='animate-loading-dot delay-900'>.</span>
          </span>
        </p>
      </div>
    </div>
